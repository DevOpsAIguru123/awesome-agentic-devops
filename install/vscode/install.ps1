# One-command installer: official agent skills -> vscode.
#
#   iwr https://raw.githubusercontent.com/DevOpsAIguru123/awesome-agentic-devops/main/install/vscode/install.ps1 -OutFile install.ps1
...
try {
    ...
    & $py.Path (Join-Path $tmp "install_skills.py") --agent vscode --repos (Join-Path $tmp "repos.yaml") @args
}
