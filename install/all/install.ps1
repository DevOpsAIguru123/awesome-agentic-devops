...
#
#   iwr https://raw.githubusercontent.com/DevOpsAIguru123/awesome-agentic-devops/main/install/all/install.ps1 -OutFile install.ps1
...
try {
    ...
    & $py.Path (Join-Path $tmp "install_skills.py") --agent all --repos (Join-Path $tmp "repos.yaml") @args
}
